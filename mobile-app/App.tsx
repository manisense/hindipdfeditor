 ...
 * Modern 4-tab mobile navigation (Home, Files, Tools, Profile)
      ...
      <AppPopupProvider>
        ...
        >
          ...
          {activeTool === 'translate' && (
            <TranslatePdfTool initialFileUri={openedFile?.uri} initialFileName={openedFile?.name} />
          )}
          {activeTool === 'merge' && (
          ...
          {activeTool === 'compress' && (
            <CompressPdfTool initialFileUri={openedFile?.uri} initialFileName={openedFile?.name} />
          )}
        </ToolShell>
      </AppPopupProvider>
    </SafeAreaProvider>
