...
export function ArticlesSection() {
  ...
  const articlesEn = [
    ...
    },
    {
      ...
      title: 'How to Merge Multiple Hindi PDF Files Online in Order',
      desc: 'Combine certificates, annexures and scanned pages into one PDF in the order you need, without uploading them.',
